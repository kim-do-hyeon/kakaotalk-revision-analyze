...
_KEY = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00' # INPUT YOUR KEY
_IV  = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00' # INPUT YOUR IV
key_cache = {}
...
class android_decrypter :
	...
	def _derive_aes_key(self, user_id, encType):
		...
		base_key = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00' # INPUT YOUR KEY
		iv = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00' # INPUT YOUR IV
